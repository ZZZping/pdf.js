...
var AnnotationEditorUIManager = /*#__PURE__*/function () {
  ...
  _createClass(AnnotationEditorUIManager, [{
    ...
    value: function getEditors(pageIndex) {
      ...
      var _iterator4 = _createForOfIteratorHelper(_classPrivateFieldGet(this, _allEditors).values()),
          _step4;
    ...
    key: "addCommands",
    value: function addCommands(cmd, undo) {
      _classPrivateFieldGet(this, _commandManager).add(cmd, undo);
    }
  }, {
    key: "allowClick",
    get: function get() {
    ...
    value: function suppress(layer) {
      ...
      if (_classPrivateFieldGet(this, _isAllSelected)) {
        ...
        cmd = function cmd() {
          var _iterator5 = _createForOfIteratorHelper(editors),
              _step5;
    ...
    value: function selectAll() {
      ...
      var _iterator7 = _createForOfIteratorHelper(_classPrivateFieldGet(this, _allEditors).values()),
          _step7;
...
function _enableAll2() {
  if (!_classPrivateFieldGet(this, _isEnabled)) {
    ...
    var _iterator9 = _createForOfIteratorHelper(_classPrivateFieldGet(this, _allLayers)),
        _step9;
...
var AnnotationEditorLayer = /*#__PURE__*/function () {
  ...
  _createClass(AnnotationEditorLayer, [{
    key: "addCommands",
    value: function addCommands(cmd, undo) {
      _classPrivateFieldGet(this, _uiManager).addCommands(cmd, undo);
    }
  }, {
    key: "undo",
    value: function undo() {
...
var FreeTextEditor = /*#__PURE__*/function (_AnnotationEditor) {
  ...
  _createClass(FreeTextEditor, [{
    ...
    key: "getInitialTranslation",
    value: function getInitialTranslation() {
      return [-FreeTextEditor._internalPadding * this.parent.zoomFactor, -(FreeTextEditor._internalPadding + _classPrivateFieldGet(this, _fontSize)) * this.parent.zoomFactor];
    }
  }, {
    key: "rebuild",
    value: function rebuild() {
    ...
    value: function render() {
      ...
      style.fontSize = "calc(".concat(_classPrivateFieldGet(this, _fontSize), "px * var(--zoom-factor))");
    ...
    value: function serialize() {
      ...
      var padding = FreeTextEditor._internalPadding * this.parent.zoomFactor;
      ...
      return {
        ...
        color: [0, 0, 0],
        fontSize: _classPrivateFieldGet(this, _fontSize) / _display_utils.PixelsPerInch.PDF_TO_CSS_UNITS,
...
var InkEditor = /*#__PURE__*/function (_AnnotationEditor) {
  ...
  function InkEditor(params) {
    ...
    _classPrivateFieldSet(_assertThisInitialized(_this), _baseWidth, _classPrivateFieldSet(_assertThisInitialized(_this), _baseHeight, 0));

    _classPrivateFieldSet(_assertThisInitialized(_this), _aspectRatio, 0);

    _classPrivateFieldSet(_assertThisInitialized(_this), _disableEditing, false);

    _classPrivateFieldSet(_assertThisInitialized(_this), _observer, null);
  ...
  _createClass(WidgetAnnotationElement, [{
    ...
    value: function _setTextStyle(element) {
      ...
      if (this.data.multiLine) {
        ...
        style.fontSize = "".concat(Math.min(fontSize, Math.round(lineHeight / _util.LINE_FACTOR)), "px");
      } else {
        var _height = Math.abs(this.data.rect[3] - this.data.rect[1]);

        style.fontSize = "".concat(Math.min(fontSize, Math.round(_height / _util.LINE_FACTOR)), "px");
      }
    ...
    value: function render() {
      ...
      if (this.enableScripting && this.hasJSActions) {
        selectElement.addEventListener("updatefromsandbox", function (jsEvent) {
          ...
          _this11._dispatchEventFromSandbox(actions, jsEvent);
        });
        selectElement.addEventListener("input", function (event) {
          ...
          (_this11$linkService$e = _this11.linkService.eventBus) === null || _this11$linkService$e === void 0 ? void 0 : _this11$linkService$e.dispatch("dispatcheventinsandbox", {
            source: _this11,
            detail: {
              id: id,
              name: "Keystroke",
...
var PolylineAnnotationElement = /*#__PURE__*/function (_AnnotationElement9) {
  ...
  function PolylineAnnotationElement(parameters) {
    ...
    _this12.containerClassName = "polylineAnnotation";
...
var PolygonAnnotationElement = /*#__PURE__*/function (_PolylineAnnotationEl) {
  ...
  function PolygonAnnotationElement(parameters) {
    ...
    _this13.containerClassName = "polygonAnnotation";
    _this13.svgElementName = "svg:polygon";
    return _this13;
  }
...
var InkAnnotationElement = /*#__PURE__*/function (_AnnotationElement11) {
  ...
  function InkAnnotationElement(parameters) {
    ...
    _this14.containerClassName = "inkAnnotation";
...
var FileAttachmentAnnotationElement = /*#__PURE__*/function (_AnnotationElement17) {
  ...
  function FileAttachmentAnnotationElement(parameters) {
    var _this15$linkService$e;

    var _this15;

    _classCallCheck(this, FileAttachmentAnnotationElement);

    _this15 = _super23.call(this, parameters, {
      isRenderable: true
    });
    var _this15$data$file = _this15.data.file,
        filename = _this15$data$file.filename,
        content = _this15$data$file.content;
    _this15.filename = (0, _display_utils.getFilenameFromUrl)(filename);
    _this15.content = content;
    (_this15$linkService$e = _this15.linkService.eventBus) === null || _this15$linkService$e === void 0 ? void 0 : _this15$linkService$e.dispatch("fileattachmentannotation", {
      source: _assertThisInitialized(_this15),
      filename: filename,
      content: content
    });
    return _this15;
...
var pdfjsVersion = '2.15.117';
var pdfjsBuild = '1a6ae5f03';
{
  if (_is_node.isNodeJS) {
